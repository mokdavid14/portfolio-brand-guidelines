					    ...
					    <dl class="accordion" data-accordion>
						  ...
						  <dd class="accordion-navigation">
						    ...
						    <div id="panel2" class="content">
					    		...
					    		<p>Within this size range, the ® symbol on thePlayStation® family mark must be(<img src="assets/images/logo_size/phi-notation.png" alt="phi"> = 7 pixels) and the ™ symbol on the PS4™ logo must be “H = 0.7mm” (H = 5 pixels) regardless of the logo size.</p>							      
						    </div>
						  </dd>
